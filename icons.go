// Package fyne_lucide provides Lucide (https://lucide.dev/icons) for Fyne apps.
//
...
// Lookup returns the icon with the given name (as listed on https://lucide.dev/icons),
